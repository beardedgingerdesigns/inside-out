...
The Inside Out brand system: voice, palette, typography, asset inventory. Project-specific section (not in the AIOS canonical layout) but load-bearing for this project.

## Pages
- [voice.md](voice.md) — tone of voice, anti-patterns, dual-audience handling.
