...
3. Claude will:
   ...
   - Draft a summary page at `docs/wiki/sources/YYYY-MM-DD-<slug>.md`.
   - Propose updates to existing wiki pages.
   - Walk those updates with you, apply them, update the relevant section index, append a `docs/wiki/log/YYYY-MM-DD-<slug>.md` entry.
...
- LLM-generated content — those go in `docs/wiki/`.
- The CLAUDE.md, WIKI-CLAUDE.md, or any operating instructions — those are project-level, not sources.
